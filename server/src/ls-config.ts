...
export class LSConfigManager {
  ...
  update(config: DeepPartial<LSConfig>): void {
    ...
    this.config = { ...defaultLSConfig, ...this.config, ...config } as LSConfig;
   ...
   * @param key a string which is a path.
   */
   ...
   * - Else the extension's Prettier config is used as a starting point,
  ...
  updateTsJsUserPreferences(
    config: Record<TsUserConfigLang, TSUserConfig>
  ): void {
  ...
  private _updateTsUserPreferences(
    ...
    this.tsUserPreferences[lang] = {
      ...
      importModuleSpecifierPreference:
        config.preferences?.importModuleSpecifier,
      importModuleSpecifierEnding:
        config.preferences?.importModuleSpecifierEnding,
      includePackageJsonAutoImports:
        config.preferences?.includePackageJsonAutoImports,
